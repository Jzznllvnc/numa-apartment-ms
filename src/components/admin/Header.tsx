      ...
      <form onSubmit={handleSearch} className="relative">
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search..."
            className="pl-10 pr-4 py-2 w-32 bg-gray-100 dark:bg-gray-800 border-0 rounded-lg text-sm placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-200 lg:hidden"
          />
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 w-80 bg-gray-100 dark:bg-gray-800 border-0 rounded-lg text-sm placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-200 hidden lg:block"
          />
        </div>
      </form>
...
export function AdminHeader() {
  return (
    <div className="sticky top-0 z-30 bg-white/95 backdrop-blur-sm border-b border-gray-200 px-6 lg:px-8 h-[96px] flex items-center shadow-sm dark:bg-gray-900/95 dark:border-gray-700">
      <div className="flex items-center justify-between w-full">
        {/* Left side - Empty on mobile, Search Bar on larger screens */}
        <div className="flex-shrink-0 hidden lg:block">
          <SearchBar />
        </div>

        {/* Right side - Search (mobile), Theme, Notifications, Profile */}
        <div className="flex items-center space-x-3 ml-auto lg:ml-0">
          
          {/* Mobile Search Bar - beside theme toggle */}
